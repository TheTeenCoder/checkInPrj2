...
class Questionaire extends React.Component {
  ...
  handleSubmit(e) {
    ...
    axios
      .post(
        "https://g5dckfl5sh.execute-api.us-east-2.amazonaws.com/dev/submit-questionair",
        {
  ...
  render() {
    return (
      <div
        id="questionaire"
        className=" flex  flex-col  content-around px-10 py-10  space-y-2 text-left text-xs md:text-xl"
      >
        <p className=" text-red-500">*Fill this in order to get into SLMCS</p>
        <h1 className="">Questionaire.</h1>
        <div id="question-group ">
          <h1>
            Have you had any of the following symptoms in the past 14 days not
                ...
                <td>
                  <FormControl component="fieldset">
                    <RadioGroup
                      aria-label="Yes/No"
                      row
                      value={this.state.ContactLast14}
                      onChange={this.onChange}
                      name="ContactLast14"
                    >
                      <FormControlLabel
          ...
          <button
            className="mt-5 rounded-md p-2 text-white bg-blue-400 border-2 border-white  w-full"
        ...
        {this.state.msg ? (
          <label className="text-xl text-red-500">{this.state.msg}</label>
        ) : null}
      </div>
    );
  }
